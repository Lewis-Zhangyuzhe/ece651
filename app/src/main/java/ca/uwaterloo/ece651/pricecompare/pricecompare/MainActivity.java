...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button1 = (Button)findViewById(R.id.cat_button_1);
        ...
        Button button2 = (Button)findViewById(R.id.cat_button_0);
        ...
        Button button3 = findViewById(R.id.cat_button_2);
        ...
        Button button4 = findViewById(R.id.cat_button_3);
        ...
        Button button5 = findViewById(R.id.cat_button_4);
        ...
        Button button6 = findViewById(R.id.cat_button_5);
